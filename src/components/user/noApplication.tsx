...
import ApplicantsHeader from "../header/applicantsHeader";
    ...
    <div>
      ...
      <div className="w-[70%] h-20 mx-auto py-5 mb-2 ">
        ...
        <div className="grid grid-cols-3 gap-6 my-4">
          <div className="h-40 mr-2 p-5 text-white pb-8 rounded-md col-span-3 lg:col-span-2 bg-gradient-to-r from-violet-900 via-purple-800 to-purple-900">
