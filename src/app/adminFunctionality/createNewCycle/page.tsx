  ...
  return (
    <div className='min-h-screen pl-[250px] pr-[40px] pt-[50px] pb-[60px]' style={{ background: 'rgb(243, 244, 246)' }}>
      <div className='text-black mb-8'>
        ...
        <p className='text-gray-600'>Use this form to create a new cycle and assign periods.</p>
      </div>

      <form onSubmit={handleSubmit} className='bg-white rounded-xl shadow-2xl p-8 max-w-5xl'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-6'>
          <div>
            <label className='block text-gray-700 font-medium mb-2'>Cycle Name</label>
            <input
              type='text'
              value={cyclename}
