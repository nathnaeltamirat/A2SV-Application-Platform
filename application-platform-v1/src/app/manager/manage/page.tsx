...
} from "@/app/api/manager/fetchApplicationById";
import {
  fetchAllReviewers,
  ReviewerItem,
} from "@/app/api/manager/fetchAllReviewers";
import { assignReviewer } from "@/app/api/manager/assignReviewer";
import { getUserById } from "@/app/api/admin/getUserById";
import { Decission } from "@/app/api/manager/decession";
  ...
  return (
    <div className="bg-gray-100 text-black">
      ...
      <div className="bg-gray-100 p-6 min-h-screen">
        <Link
          href="/dashboard"
          className="text-sm text-gray-500 mb-2 inline-block"
        >
          &lt; Back to Dashboard
        </Link>
