...
import HorizontalBarChart from "../../../components/admin/chartComponents/HorizontalBarChart";
import PieChart from "../../../components/admin/chartComponents/PieChart";
import BarChart from "../../../components/admin/chartComponents/BarChart";
  ...
  return (
    <>
      ...
      >
        ...
        <p>
          The analysis data displayed below is dummy due to an inadequate API.
        </p>
      </div>
      <div
        className="h-auto text-black pl-[150px] pt-[50px] py-10 pr-8"
        style={{ background: "rgb(243, 244, 246)" }}
      >
        <div className="flex flex-col space-x-3">
          <div className="font-medium text-3xl">Application Analytics</div>
          <div className="font-light text-gray-500 text-[16px]">
        ...
        <div className="flex flex-col md:flex-row mt-6 md:space-x-6 space-y-6 md:space-y-0">
          <div className="w-full max-w-[589px]  bg-white rounded-[7px] shadow-2xl shadow-gray-300 p-5">
            ...
            <div className="font-light text-gray-500 text-[14px]">
              The chart visualizes the applicant&apos;s journey from submission to
              acceptance.
            </div>
          ...
          <div className="w-full max-w-[589px]  bg-white rounded-[7px] shadow-2xl shadow-gray-300 p-5">
            ...
            <div className="font-light text-gray-500 text-[14px]">
              Breakdown of Applicants by their Univeristy
            </div>
            <div className="">
