...
const NoApplication = () => {
  ...
  return (
    <div className="w-[70%]  mx-auto py-5 mb-2  text-black">
      <h1 className="font-bold text-xl ">Welcome, {full_name}</h1>
      ...
      <div className="grid grid-cols-3 gap-6 my-4">
        ...
        <div className="flex flex-col col-span-3 md:col-span-1">
          <div className=" bg-white  mr-2  p-4 rounded-md">
            ...
            <p className="text-xs bg-blue-300 w-32 h-6 font-extrabold mb-2 text-blue-600 rounded-xl pl-2 py-1 mt-2">
              75% COMPLETE
            </p>
