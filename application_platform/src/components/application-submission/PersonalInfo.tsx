...
const PersonalInfo =  forwardRef<PersonalInfoHandle,Props>(({onNext},ref)=>{

  const dispatch = useDispatch();
  const personalInfoState = useSelector((state: RootState) => state.applicant);
    ...
    <div className="width-[740] p-3">
      ...
      <form noValidate>
        <div className="flex flex-wrap  justify-between gap-10 ">
          ...
          <div>
            <label htmlFor="education" className="block">School/ University</label>
            <input
              type="text"
              value={values.school}
          ...
          <div>
            <label htmlFor="degree_program block" className="block">Degree Program</label>
            <input
              type="text"
              value={values.degree}
              className="border-b mb-2 border-gray-300 focus:outline-none focus:border-b-2 focus:border-blue-500"
           ...
           <div>
            <label htmlFor="degree_program block" className="block">Student ID</label>
            <input
              type="text"
