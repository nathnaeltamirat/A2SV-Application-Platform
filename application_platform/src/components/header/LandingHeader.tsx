  ...
  return (
    <>
        <header className='flex justify-evenly p-3 flex-wrap' style={{background:'#d7d7d7'}}>
            <img src="images/a2sv.png" className='w-22' alt="" />
            <div className='flex flex-wrap gap-8'>
                ...
                <Link href='#' className='text-white font-semibold p-1 text-sm px-2   rounded-md' style={{background:'#4f46e5'}}>Apply Now</Link>
            </div>
        </header>
    </>
  )
