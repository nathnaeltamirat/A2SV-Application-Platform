...
import { numberCycle, numberOfApplicants, numberUsers, recent } from "@/utils/adminDashboard";
import { Recent } from "@/types/adminDashboardReturn.types";
const AdminPage = () => {
          ...
          <div className="w-[30%] bg-white mr-2 pb-8 p-2 rounded-md">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm">
                ...
                <span className="block text-gray-400 text-sm">      {recentCycle && recentCycle.ago}</span>
              </p>
            </div>
          </div>
        </div>
