...
export const userApi = createApi({
  ...
  baseQuery: fetchBaseQuery({
    ...
    prepareHeaders: (headers) => {
      const token = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhNWI2Yjk1NS1iYjY5LTRhNGItYmE5Ny1kYWFlNzJiNTQ4YzAiLCJleHAiOjE3NTQ2Mzg5ODYsInR5cGUiOiJhY2Nlc3MifQ.b4kiJVSwlW49yqMiwdU-DdThGCUR-fpoNWXhdFTvS-I'; // your token
      if (token) {
