...
import UserSearch from './UserManagment/UserSearch';
import CreateUserButton from './UserManagment/CreateUserButton';
import Pagination from './UserManagment/Pagination';
import { User, UserStatus } from './UserManagment/types';
    ...
    <div className="px-4 py-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4 mb-6 flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <h1 className="text-xl font-bold text-gray-800 sm:text-2xl">User Management</h1>
          <p className="text-sm text-gray-600 sm:text-base">Administer platform users</p>
        </div>
